...
def openimage():
    global fn
    fileName = askopenfilename(initialdir='C:/Users/Nilesh/Desktop/100% code Agri pest classification/dataset/testing', title='Select image for Analysis', filetypes=[("all files", "*.*")])
    if fileName:
        IMAGE_SIZE = 200
        imgpath = fileName
        fn = fileName
