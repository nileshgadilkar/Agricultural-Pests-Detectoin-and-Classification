...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="skyblue", fg="white")
l1.place(x=590, y=50)
...
btn = tk.Button(window, text="Register", bg="skyblue",font=("",20),fg="white", width=9, height=1, command=insert)
